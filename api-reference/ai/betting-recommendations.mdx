...
api: "GET https://api.mrdoge.co/ai/betting-recommendations"
auth: "bearer"
...
curl -H "Authorization: Bearer sk_live_..." \
  "https://api.mrdoge.co/ai/betting-recommendations?confidence=High&minEdge=5&limit=5"
```
...
response = requests.get(
    'https://api.mrdoge.co/ai/betting-recommendations',
    headers={'Authorization': 'Bearer sk_live_...'},
