...
<Steps>
  ...
  <Step title="Make Your First Request">
    ...
    <CodeGroup>
    ```bash cURL
    curl -X GET "https://api.mrdoge.co/odds/events?sport=soccer&includeCompleted=false" \
    ...
    async function getEvents() {
      const response = await fetch(
        'https://api.mrdoge.co/odds/events?sport=soccer&includeCompleted=false',
        {
          headers: {
    ...
    def get_events():
        ...
        params = {'sport': 'soccer', 'includeCompleted': False}
    ...
    $url = 'https://api.mrdoge.co/odds/events?sport=soccer&includeCompleted=false';
...
<AccordionGroup>
  ...
  <Accordion title="Empty Results Array" icon="list">
    ...
    **Solutions**:
    ...
    - Use `includeCompleted=true` to see past events
...
<Card
  ...
  icon="signal-bars"
  href="https://status.mrdoge.co"
>
  Check if there are any ongoing issues or maintenance
</Card>
